<html>
<head>
        <title>Contact Us | Blue Logistics</title>
...
<p>Westlands Nairobi, Eldoret Kenya </p>

<p>Tel/ WhatsApp  No :+254 724 052 417</p>


<p><u>support<a href="#">@gmail.com</u></p>

<p>www.kenstates.netlify.app</p>
            </div>
        </div>
        <!---- about-grids ---->
            ...
            <div class="container">
                    <div class="top-footer-grids">
                            <div class="top-footer-grid">
                                    <h3>Contact us</h3>
                                    <ul class="address">
                                        <li><span class="map-pin"> </span><label>Westlands Nairobi, Eldoret Nairobi </label></li>
    ...
    <div class="bottom-footer">
            <div class="container"> 
                    <div class="bottom-footer-left">
                             ...
                             <p> &copy; Kenstate Allied All rights reserved | Powered by: <a href="http://www.facebook.com/shivtelo" target="_blank">Kenstate Allied</a></p>
                    </div>
                    <div class="clear"> </div>
            </div>
    </div>
